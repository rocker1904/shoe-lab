...
cost, and nothing about it should ever need a card. Interactive agent tooling
belongs to the author, not the pipeline — an agent may use it to *author* a
change, never to *run* one. So a proposal that adds
