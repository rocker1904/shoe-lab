...
- [x] **Step 1: `docs/shoe-stories.md`**, four sections, not two:
  ...
  - **§Checking a set of weights** — keep the one-sided method, which both specs still point at; update "Tempo does not yet", since Tempo now reads 20–24/30 with `competition`-only at 0/30.
